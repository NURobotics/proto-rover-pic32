...
HARMONYPATH=/home/tgdiriba/microchip/harmony/v1_02
NU32PATH=/home/tgdiriba/Code/nu_ws/mechatronics/pic32/PIC32quickstart
PORTA=/dev/ttyUSB0
PORTB=/dev/ttyUSB1
TERMEMU=screen
...
#the linker script
LINKSCRIPT = "src/NU32/NU32bootloaded.ld"
OBJS := src/ProtoRover/ProtoRover.cpp src/proto_rover_comm.c src/NU32/NU32.c
HDRS := include/ProtoRover/ProtoRover.h include/proto_rover_comm.h include/NU32/NU32.h
PROC = 32MX795F512L
CFLAGS=-g -O1 -x c
TARGET = out
